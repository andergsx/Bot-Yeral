...
global.owner = [
  ['51912332440', '⍣Ander࿐', true],
  ['51904678526 ', '️⍣Yeral࿐', true],
]
global.mods = [] 
global.prems = [] 
//╰─────────────────────╯
...
global.ignyc = '\n⍣Ander࿐\n⍣Yeral࿐\n' 
global.wm = '\n⍣Ander࿐\n⍣Yeral࿐\n' 
global.botname = '⍣Ander࿐'
global.me = '⍣Yeral࿐'
//╰─────────────────────╯


//᭥🥗᭢━━━━━━◜𝑻𝑬𝑿𝑻𝑶𝑺◞━━━━━━᭥🥗᭢
global.adimagen = `🌅| Iᴍᴀ́ɢᴇɴᴇs Bʏ ⍣Ander࿐🌿` 
global.adanime = `🌸| Aɴɪᴍᴇ Bʏ ⍣Ander࿐🈴` 
global.adyoutube = `🍁| Dᴇsᴄᴀʀɢᴀs ᴅᴇ YᴏᴜTᴜʙᴇ🍄` 
global.adsticker = `🏞️| Sᴛɪᴄᴋᴇʀs Bʏ ⍣Ander࿐🌺` 
global.addescargas = `📤| Dᴇsᴄᴀʀɢᴀs Bʏ ⍣Ander࿐🌸`
 //╰─────────────────────╯

 
//᭥🍃᭢━━━━━━◜𝑺𝑻𝑰𝑪𝑲𝑬𝑹𝑺◞━━━━━━᭥🍃᭢
global.packname = `🐢 ❑ Owner:\n📅 ❑ Día:\n🕒 ❑ Hora:\n🗓️ ❑ Fecha:\n🐱 ❑ By:`
global.author = `▸ Ander Y Yeral🎋\n▸ ${dia}\n▸ ${tiempo}\n▸ ${fecha}\n▸ ${botname}`
//╰────────────────────╯	
...
//᭥🌿᭢━━━━━━━◜𝑳𝑰𝑵𝑲𝑺◞━━━━━━━᭥🌿᭢
global.linkgc = 'https://chat.whatsapp.com/L1hwmI0SSFMAmTVWTyOgMW'
...
global.estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: '⍣Ander࿐\n⍣Yeral࿐', orderTitle: 'Bang', thumbnail: catalogo, sellerJid: '0@s.whatsapp.net'}}}
//╰─────────────────────╯
//᭥🌺᭢━━━━◜𝑮𝑰𝑭 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━━᭥🌺᭢
global.fgif = { key: {participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`*⍣Yeral࿐*`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `⍣Ander࿐\n      ⍣Yeral࿐`, 'jpegThumbnail': imgfgif }}}
//╰─────────────────────╯
//᭥🌺᭢━━━━◜𝑨𝑼𝑫𝑰𝑶 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━━᭥🌺᭢
...
global.fdocument = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `⍣Ander࿐\n   ⍣Yeral࿐`,jpegThumbnail: catalogo}}}
//╰─────────────────────╯
//᭥🌺᭢━━━◜𝑰𝑴𝑨𝑮𝑬𝑵 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑨◞━━━᭥🌺᭢
global.fakeimg = { key: {participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"imageMessage": { "title":`*⍣Yeral࿐*`, "h": `Hmm`,'seconds': '99999', 'imagePlayback': 'true', 'caption': `⍣Ander࿐\n    ⍣Yeral࿐`, 'jpegThumbnail': catalogo }}}
//╰─────────────────────╯
//᭥🌺᭢━━━◜𝑴𝑬𝑵𝑺𝑨𝑱𝑬 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━᭥🌺᭢
global.fakemsg = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "17608914335-1625305606@g.us" } : {}) }, message: { "extendedTextMessage": { "text":'⍣Ander࿐\n⍣Yeral࿐', "title": '⍣Ander࿐', 'jpegThumbnail': catalogo}}}
//╰─────────────────────╯
//᭥🌺᭢━◜𝑳𝑶𝑪𝑨𝑳𝑰𝒁𝑨𝑪𝑰𝑶́𝑵 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑨◞━᭥🌺᭢
global.flocation = {key : {participant : '0@s.whatsapp.net'},message: {locationMessage: {name: `⍣Ander࿐\n   ⍣Yeral࿐`,jpegThumbnail: catalogo}} }
//╰─────────────────────╯
//᭥🌺᭢━━━◜𝑽𝑰́𝑫𝑬𝑶 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━᭥🌺᭢
global.fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":`⍣Ander࿐`, "h": `Hmm`,'seconds': '2022', 'caption': `⍣Ander࿐`, 'jpegThumbnail': catalogo}} }
//╰─────────────────────╯
//᭥🌺᭢━━━◜𝑳𝑰𝑵𝑲𝑮𝑷 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━━᭥🌺᭢
global.fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "Alberto", "caption": `⍣Ander࿐\n      ⍣Yeral࿐`, 'jpegThumbnail': catalogo}} }
//╰─────────────────────╯
//᭥🌺᭢━━◜𝑷𝑹𝑶𝑫𝑼𝑪𝑻𝑶 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━᭥🌺᭢
global.fproducto = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "17608914335@s.whatsapp.net" } : {}) }, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": catalogo }, "title": `⍣Ander࿐`, "description": "NyanCatBot-MD", "currencyCode": "USD", "priceAmount1000": "200000000", "retailerId": "Ghost", "productImageCount": 1 }, "businessOwnerJid": `0@s.whatsapp.net` }}}
//╰─────────────────────╯
//᭥🌺᭢━━━◜𝑳𝑰𝑽𝑬 𝑳𝑶𝑪𝑨𝑳𝑰𝒁𝑨𝑪𝑰𝑶́𝑵◞━━━᭥🌺᭢
global.liveloc = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false  ? { remoteJid: "status@broadcast" } : {}) }, message: { "liveLocationMessage": { "caption":"⍣Ander࿐","h": `⍣Ander࿐`, 'jpegThumbnail': catalogo}}}
//╰─────────────────────╯
//᭥🌺᭢━━◜𝑷𝑹𝑶𝑫𝑼𝑪𝑻𝑶 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶 2◞━━᭥🌺᭢
global.fproducto2 = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "status@broadcast" } : {})}, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": catalogo }, "title": `⍣Ander࿐`, "retailerId": "Ander࿐", "productImageCount": 1 }, "businessOwnerJid": `0@s.whatsapp.net` }}}
//╰─────────────────────╯
//᭥🌺᭢━━◜𝑽𝑰𝑬𝑾𝑶𝑵𝑪𝑬 𝑽𝑬𝑹𝑰𝑭𝑰𝑪𝑨𝑫𝑶◞━━᭥🌺᭢
...
//᭥🌄᭢━━━━━◜𝑨𝑫 𝑫𝑬 𝑮𝑹𝑼𝑷𝑶◞━━━━━᭥🌄᭢
global.adgp = { contextInfo: { externalAdReply: { showAdAttribution: true, title: '⍣Ander࿐', body: global.botname, sourceUrl: global.linkgc, thumbnail: miniurl }}}
//╰─────────────────────╯
